...
void sortUsingPtrs(vector<Student>& students,
                   bool comp(const Student*, const Student*));
...
//   printVector(unorderedStudents);
//   insertion_sort(unorderedStudents, compareStudent);
//   printVector(unorderedStudents);
// }
...
void sortUsingPtrs(vector<Student>& students,
  ...
  vector<Student*> sp(auxStudents.size());
